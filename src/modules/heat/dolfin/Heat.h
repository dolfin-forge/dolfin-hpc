...
public:
  ...
  void eval(real block[], const AffineMap& map) const
  {
    ...
    const real G0_0_1_0 = map.det*c0_1*map.g00*map.g00 + map.det*c0_1*map.g01*map.g01;
    const real G0_0_2_1 = map.det*c0_2*map.g00*map.g10 + map.det*c0_2*map.g01*map.g11;
    const real G0_1_0_0 = map.det*c0_0*map.g10*map.g00 + map.det*c0_0*map.g11*map.g01;
    const real G0_1_0_1 = map.det*c0_0*map.g10*map.g10 + map.det*c0_0*map.g11*map.g11;
    const real G0_1_1_0 = map.det*c0_1*map.g10*map.g00 + map.det*c0_1*map.g11*map.g01;
    const real G0_1_2_1 = map.det*c0_2*map.g10*map.g10 + map.det*c0_2*map.g11*map.g11;
