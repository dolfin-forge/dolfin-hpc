...
public:
  ...
  %(classname)s(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          const dolfin::FiniteElement* (new dolfin::FiniteElement(ufc::finite_element* (new %(ufc_finite_element_classname)s()))),
                          const dolfin::DofMap *(new dolfin::DofMap(ufc::dofmap* (new %(ufc_dofmap_classname)s()), mesh)))
  {
    // Do nothing
  }
