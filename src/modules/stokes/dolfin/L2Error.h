...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G0_0_3 = det*c0_0*c0_3 + det*c1_0*c1_3;
  ...
  const real G0_1_4 = det*c0_1*c0_4 + det*c1_1*c1_4;
  ...
  const real G0_2_5 = det*c0_2*c0_5 + det*c1_2*c1_5;
  const real G0_3_0 = det*c0_3*c0_0 + det*c1_3*c1_0;
  const real G0_3_3 = det*c0_3*c0_3 + det*c1_3*c1_3;
  const real G0_3_4 = det*c0_3*c0_4 + det*c1_3*c1_4;
  const real G0_3_5 = det*c0_3*c0_5 + det*c1_3*c1_5;
  const real G0_4_1 = det*c0_4*c0_1 + det*c1_4*c1_1;
  const real G0_4_3 = det*c0_4*c0_3 + det*c1_4*c1_3;
  const real G0_4_4 = det*c0_4*c0_4 + det*c1_4*c1_4;
  const real G0_4_5 = det*c0_4*c0_5 + det*c1_4*c1_5;
  const real G0_5_2 = det*c0_5*c0_2 + det*c1_5*c1_2;
  const real G0_5_3 = det*c0_5*c0_3 + det*c1_5*c1_3;
  const real G0_5_4 = det*c0_5*c0_4 + det*c1_5*c1_4;
  const real G0_5_5 = det*c0_5*c0_5 + det*c1_5*c1_5;
  const real G0_6_6 = det*c0_6*c0_6 + det*c1_6*c1_6;
  const real G0_6_7 = det*c0_6*c0_7 + det*c1_6*c1_7;
  const real G0_6_8 = det*c0_6*c0_8 + det*c1_6*c1_8;
  const real G0_6_9 = det*c0_6*c0_9 + det*c1_6*c1_9;
  const real G0_7_6 = det*c0_7*c0_6 + det*c1_7*c1_6;
  const real G0_7_7 = det*c0_7*c0_7 + det*c1_7*c1_7;
  const real G0_7_8 = det*c0_7*c0_8 + det*c1_7*c1_8;
  const real G0_7_10 = det*c0_7*c0_10 + det*c1_7*c1_10;
  const real G0_8_6 = det*c0_8*c0_6 + det*c1_8*c1_6;
  const real G0_8_7 = det*c0_8*c0_7 + det*c1_8*c1_7;
  const real G0_8_8 = det*c0_8*c0_8 + det*c1_8*c1_8;
  const real G0_8_11 = det*c0_8*c0_11 + det*c1_8*c1_11;
  const real G0_9_6 = det*c0_9*c0_6 + det*c1_9*c1_6;
  const real G0_9_9 = det*c0_9*c0_9 + det*c1_9*c1_9;
  const real G0_9_10 = det*c0_9*c0_10 + det*c1_9*c1_10;
  const real G0_9_11 = det*c0_9*c0_11 + det*c1_9*c1_11;
  const real G0_10_7 = det*c0_10*c0_7 + det*c1_10*c1_7;
  const real G0_10_9 = det*c0_10*c0_9 + det*c1_10*c1_9;
  const real G0_10_10 = det*c0_10*c0_10 + det*c1_10*c1_10;
  const real G0_10_11 = det*c0_10*c0_11 + det*c1_10*c1_11;
  const real G0_11_8 = det*c0_11*c0_8 + det*c1_11*c1_8;
  const real G0_11_9 = det*c0_11*c0_9 + det*c1_11*c1_9;
  const real G0_11_10 = det*c0_11*c0_10 + det*c1_11*c1_10;
  const real G0_11_11 = det*c0_11*c0_11 + det*c1_11*c1_11;
  ...
  const real G1_0_3 = det*c0_0*c1_3 + det*c1_0*c0_3;
  ...
  const real G1_1_4 = det*c0_1*c1_4 + det*c1_1*c0_4;
  ...
  const real G1_2_5 = det*c0_2*c1_5 + det*c1_2*c0_5;
  const real G1_3_0 = det*c0_3*c1_0 + det*c1_3*c0_0;
  const real G1_3_3 = det*c0_3*c1_3 + det*c1_3*c0_3;
  const real G1_3_4 = det*c0_3*c1_4 + det*c1_3*c0_4;
  const real G1_3_5 = det*c0_3*c1_5 + det*c1_3*c0_5;
  const real G1_4_1 = det*c0_4*c1_1 + det*c1_4*c0_1;
  const real G1_4_3 = det*c0_4*c1_3 + det*c1_4*c0_3;
  const real G1_4_4 = det*c0_4*c1_4 + det*c1_4*c0_4;
  const real G1_4_5 = det*c0_4*c1_5 + det*c1_4*c0_5;
  const real G1_5_2 = det*c0_5*c1_2 + det*c1_5*c0_2;
  const real G1_5_3 = det*c0_5*c1_3 + det*c1_5*c0_3;
  const real G1_5_4 = det*c0_5*c1_4 + det*c1_5*c0_4;
  const real G1_5_5 = det*c0_5*c1_5 + det*c1_5*c0_5;
  const real G1_6_6 = det*c0_6*c1_6 + det*c1_6*c0_6;
  const real G1_6_7 = det*c0_6*c1_7 + det*c1_6*c0_7;
  const real G1_6_8 = det*c0_6*c1_8 + det*c1_6*c0_8;
  const real G1_6_9 = det*c0_6*c1_9 + det*c1_6*c0_9;
  const real G1_7_6 = det*c0_7*c1_6 + det*c1_7*c0_6;
  const real G1_7_7 = det*c0_7*c1_7 + det*c1_7*c0_7;
  const real G1_7_8 = det*c0_7*c1_8 + det*c1_7*c0_8;
  const real G1_7_10 = det*c0_7*c1_10 + det*c1_7*c0_10;
  const real G1_8_6 = det*c0_8*c1_6 + det*c1_8*c0_6;
  const real G1_8_7 = det*c0_8*c1_7 + det*c1_8*c0_7;
  const real G1_8_8 = det*c0_8*c1_8 + det*c1_8*c0_8;
  const real G1_8_11 = det*c0_8*c1_11 + det*c1_8*c0_11;
  const real G1_9_6 = det*c0_9*c1_6 + det*c1_9*c0_6;
  const real G1_9_9 = det*c0_9*c1_9 + det*c1_9*c0_9;
  const real G1_9_10 = det*c0_9*c1_10 + det*c1_9*c0_10;
  const real G1_9_11 = det*c0_9*c1_11 + det*c1_9*c0_11;
  const real G1_10_7 = det*c0_10*c1_7 + det*c1_10*c0_7;
  const real G1_10_9 = det*c0_10*c1_9 + det*c1_10*c0_9;
  const real G1_10_10 = det*c0_10*c1_10 + det*c1_10*c0_10;
  const real G1_10_11 = det*c0_10*c1_11 + det*c1_10*c0_11;
  const real G1_11_8 = det*c0_11*c1_8 + det*c1_11*c0_8;
  const real G1_11_9 = det*c0_11*c1_9 + det*c1_11*c0_9;
  const real G1_11_10 = det*c0_11*c1_10 + det*c1_11*c0_10;
  const real G1_11_11 = det*c0_11*c1_11 + det*c1_11*c0_11;
