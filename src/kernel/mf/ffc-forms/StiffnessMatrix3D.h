...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    const double G0_0_0_0 = det*(c0_0_0_0*Jinv_00*Jinv_00 + c0_1_0_0*Jinv_01*Jinv_01 + c0_2_0_0*Jinv_02*Jinv_02);
    const double G0_0_0_1 = det*(c0_0_0_0*Jinv_00*Jinv_10 + c0_1_0_0*Jinv_01*Jinv_11 + c0_2_0_0*Jinv_02*Jinv_12);
    const double G0_0_0_2 = det*(c0_0_0_0*Jinv_00*Jinv_20 + c0_1_0_0*Jinv_01*Jinv_21 + c0_2_0_0*Jinv_02*Jinv_22);
    const double G0_0_1_0 = det*(c0_0_0_0*Jinv_10*Jinv_00 + c0_1_0_0*Jinv_11*Jinv_01 + c0_2_0_0*Jinv_12*Jinv_02);
    const double G0_0_1_1 = det*(c0_0_0_0*Jinv_10*Jinv_10 + c0_1_0_0*Jinv_11*Jinv_11 + c0_2_0_0*Jinv_12*Jinv_12);
    const double G0_0_1_2 = det*(c0_0_0_0*Jinv_10*Jinv_20 + c0_1_0_0*Jinv_11*Jinv_21 + c0_2_0_0*Jinv_12*Jinv_22);
    const double G0_0_2_0 = det*(c0_0_0_0*Jinv_20*Jinv_00 + c0_1_0_0*Jinv_21*Jinv_01 + c0_2_0_0*Jinv_22*Jinv_02);
    const double G0_0_2_1 = det*(c0_0_0_0*Jinv_20*Jinv_10 + c0_1_0_0*Jinv_21*Jinv_11 + c0_2_0_0*Jinv_22*Jinv_12);
    const double G0_0_2_2 = det*(c0_0_0_0*Jinv_20*Jinv_20 + c0_1_0_0*Jinv_21*Jinv_21 + c0_2_0_0*Jinv_22*Jinv_22);
...
public:
  ...
  virtual const char* signature() const
  {
    return "w0_a0(dXa1/dx0)(dXa2/dx0) | va0*((d/dXa1)vi0)*((d/dXa2)vi1)*dX(0) + w0_a0(dXa1/dx1)(dXa2/dx1) | va0*((d/dXa1)vi0)*((d/dXa2)vi1)*dX(0) + w0_a0(dXa1/dx2)(dXa2/dx2) | va0*((d/dXa1)vi0)*((d/dXa2)vi1)*dX(0)";
  }
...
public:
  ...
  StiffnessMatrix3DBilinearForm(dolfin::Function& w0) : dolfin::Form()
  {
...
private:
  ...
  // UFC form
  UFC_StiffnessMatrix3DBilinearForm __form;
