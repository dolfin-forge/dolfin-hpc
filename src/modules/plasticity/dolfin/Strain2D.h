...
namespace dolfin { namespace Strain2D {
...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G1_3_0 = det*c0_3*map.g01;
  const real G1_3_1 = det*c0_3*map.g11;
  const real G1_4_0 = det*c0_4*map.g01;
  const real G1_5_1 = det*c0_5*map.g11;
  const real G2_0_0 = det*c0_0*map.g01;
  const real G2_0_1 = det*c0_0*map.g11;
  const real G2_1_0 = det*c0_1*map.g01;
  const real G2_2_1 = det*c0_2*map.g11;
  const real G3_3_0 = det*c0_3*map.g00;
  const real G3_3_1 = det*c0_3*map.g10;
  const real G3_4_0 = det*c0_4*map.g00;
  const real G3_5_1 = det*c0_5*map.g10;
  ...
  block[1] = -4.999999999999997e-01*G1_3_0 - 4.999999999999996e-01*G1_3_1 + 4.999999999999997e-01*G1_4_0 + 4.999999999999996e-01*G1_5_1;
  block[2] = -4.999999999999997e-01*G2_0_0 - 4.999999999999996e-01*G2_0_1 + 4.999999999999997e-01*G2_1_0 + 4.999999999999996e-01*G2_2_1 - 4.999999999999997e-01*G3_3_0 - 4.999999999999996e-01*G3_3_1 + 4.999999999999997e-01*G3_4_0 + 4.999999999999996e-01*G3_5_1;
}
