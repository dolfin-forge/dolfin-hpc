...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G1_0_0 = det*c1_0*map.g00 + det*c0*c2_0*map.g00;
  const real G1_0_1 = det*c1_0*map.g10 + det*c0*c2_0*map.g10;
  const real G1_0_2 = det*c1_0*map.g20 + det*c0*c2_0*map.g20;
  const real G2_3_0 = det*c1_3*map.g01 + det*c0*c2_3*map.g01;
  const real G2_3_1 = det*c1_3*map.g11 + det*c0*c2_3*map.g11;
  const real G2_3_2 = det*c1_3*map.g21 + det*c0*c2_3*map.g21;
  const real G3_6_0 = det*c1_6*map.g02 + det*c0*c2_6*map.g02;
  const real G3_6_1 = det*c1_6*map.g12 + det*c0*c2_6*map.g12;
  const real G3_6_2 = det*c1_6*map.g22 + det*c0*c2_6*map.g22;
  const real G4_1_0 = det*c1_1*map.g00 + det*c0*c2_1*map.g00;
  const real G4_1_1 = det*c1_1*map.g10 + det*c0*c2_1*map.g10;
  const real G4_1_2 = det*c1_1*map.g20 + det*c0*c2_1*map.g20;
  const real G5_4_0 = det*c1_4*map.g01 + det*c0*c2_4*map.g01;
  const real G5_4_1 = det*c1_4*map.g11 + det*c0*c2_4*map.g11;
  const real G5_4_2 = det*c1_4*map.g21 + det*c0*c2_4*map.g21;
  const real G6_7_0 = det*c1_7*map.g02 + det*c0*c2_7*map.g02;
  const real G6_7_1 = det*c1_7*map.g12 + det*c0*c2_7*map.g12;
  const real G6_7_2 = det*c1_7*map.g22 + det*c0*c2_7*map.g22;
  const real G7_2_0 = det*c1_2*map.g00 + det*c0*c2_2*map.g00;
  const real G7_2_1 = det*c1_2*map.g10 + det*c0*c2_2*map.g10;
  const real G7_2_2 = det*c1_2*map.g20 + det*c0*c2_2*map.g20;
  const real G8_5_0 = det*c1_5*map.g01 + det*c0*c2_5*map.g01;
  const real G8_5_1 = det*c1_5*map.g11 + det*c0*c2_5*map.g11;
  const real G8_5_2 = det*c1_5*map.g21 + det*c0*c2_5*map.g21;
  const real G9_8_0 = det*c1_8*map.g02 + det*c0*c2_8*map.g02;
  const real G9_8_1 = det*c1_8*map.g12 + det*c0*c2_8*map.g12;
  const real G9_8_2 = det*c1_8*map.g22 + det*c0*c2_8*map.g22;
