...
#ifndef __CNSRESENERGY_H
#define __CNSRESENERGY_H
...
namespace dolfin { namespace CNSResEnergy {
...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G2_0_0_0_0 = det*c1_0*c2_0*c4_0*map.g00 + det*c1_0*c0_0*c4_0*map.g00;
  const real G2_0_0_0_1 = det*c1_0*c2_0*c4_0*map.g10 + det*c1_0*c0_0*c4_0*map.g10;
  const real G2_0_1_0_0 = det*c1_0*c2_1*c4_0*map.g00 + det*c1_0*c0_1*c4_0*map.g00;
  const real G2_0_2_0_1 = det*c1_0*c2_2*c4_0*map.g10 + det*c1_0*c0_2*c4_0*map.g10;
  const real G2_1_0_0_0 = det*c1_1*c2_0*c4_0*map.g00 + det*c1_1*c0_0*c4_0*map.g00;
  const real G2_1_0_0_1 = det*c1_1*c2_0*c4_0*map.g10 + det*c1_1*c0_0*c4_0*map.g10;
  const real G2_1_1_0_0 = det*c1_1*c2_1*c4_0*map.g00 + det*c1_1*c0_1*c4_0*map.g00;
  const real G2_1_2_0_1 = det*c1_1*c2_2*c4_0*map.g10 + det*c1_1*c0_2*c4_0*map.g10;
  const real G2_2_0_0_0 = det*c1_2*c2_0*c4_0*map.g00 + det*c1_2*c0_0*c4_0*map.g00;
  const real G2_2_0_0_1 = det*c1_2*c2_0*c4_0*map.g10 + det*c1_2*c0_0*c4_0*map.g10;
  const real G2_2_1_0_0 = det*c1_2*c2_1*c4_0*map.g00 + det*c1_2*c0_1*c4_0*map.g00;
  const real G2_2_2_0_1 = det*c1_2*c2_2*c4_0*map.g10 + det*c1_2*c0_2*c4_0*map.g10;
  const real G3_3_0_0_0 = det*c1_3*c2_0*c4_0*map.g01 + det*c1_3*c0_0*c4_0*map.g01;
  const real G3_3_0_0_1 = det*c1_3*c2_0*c4_0*map.g11 + det*c1_3*c0_0*c4_0*map.g11;
  const real G3_3_1_0_0 = det*c1_3*c2_1*c4_0*map.g01 + det*c1_3*c0_1*c4_0*map.g01;
  const real G3_3_2_0_1 = det*c1_3*c2_2*c4_0*map.g11 + det*c1_3*c0_2*c4_0*map.g11;
  const real G3_4_0_0_0 = det*c1_4*c2_0*c4_0*map.g01 + det*c1_4*c0_0*c4_0*map.g01;
  const real G3_4_0_0_1 = det*c1_4*c2_0*c4_0*map.g11 + det*c1_4*c0_0*c4_0*map.g11;
  const real G3_4_1_0_0 = det*c1_4*c2_1*c4_0*map.g01 + det*c1_4*c0_1*c4_0*map.g01;
  const real G3_4_2_0_1 = det*c1_4*c2_2*c4_0*map.g11 + det*c1_4*c0_2*c4_0*map.g11;
  const real G3_5_0_0_0 = det*c1_5*c2_0*c4_0*map.g01 + det*c1_5*c0_0*c4_0*map.g01;
  const real G3_5_0_0_1 = det*c1_5*c2_0*c4_0*map.g11 + det*c1_5*c0_0*c4_0*map.g11;
  const real G3_5_1_0_0 = det*c1_5*c2_1*c4_0*map.g01 + det*c1_5*c0_1*c4_0*map.g01;
  const real G3_5_2_0_1 = det*c1_5*c2_2*c4_0*map.g11 + det*c1_5*c0_2*c4_0*map.g11;
