...
namespace dolfin
{
  ...
  public:
    ...
    XMLMeshFunction(MeshFunction<uint>& meshfunction);
    XMLMeshFunction(MeshFunction<real>& meshfunction);
  ...
  private:
    ...
    MeshFunction<uint>* _uimeshfunction;
    MeshFunction<real>* _dmeshfunction;
