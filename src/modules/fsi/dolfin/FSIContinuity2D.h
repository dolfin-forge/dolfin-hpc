...
#ifndef __FSICONTINUITY2D_H
#define __FSICONTINUITY2D_H
...
namespace dolfin { namespace FSIContinuity2D {
...
void BilinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G0_0_0_0 = det*c0_0*map.g00*map.g00 + det*c0_0*map.g01*map.g01;
  const real G0_0_0_1 = det*c0_0*map.g00*map.g10 + det*c0_0*map.g01*map.g11;
  const real G0_0_1_0 = det*c0_0*map.g10*map.g00 + det*c0_0*map.g11*map.g01;
  const real G0_0_1_1 = det*c0_0*map.g10*map.g10 + det*c0_0*map.g11*map.g11;
  const real G1_ = det;

  // Compute element tensor
  block[0] = 4.999999999999998e-01*G0_0_0_0 + 4.999999999999997e-01*G0_0_0_1 + 4.999999999999997e-01*G0_0_1_0 + 4.999999999999996e-01*G0_0_1_1 + 7.499999999999986e-04*G1_;
  block[1] = -4.999999999999998e-01*G0_0_0_0 - 4.999999999999997e-01*G0_0_1_0 + 3.749999999999992e-04*G1_;
  block[2] = -4.999999999999997e-01*G0_0_0_1 - 4.999999999999996e-01*G0_0_1_1 + 3.749999999999994e-04*G1_;
  block[3] = -4.999999999999998e-01*G0_0_0_0 - 4.999999999999997e-01*G0_0_0_1 + 3.749999999999992e-04*G1_;
  block[4] = 4.999999999999998e-01*G0_0_0_0 + 7.499999999999985e-04*G1_;
  block[5] = 4.999999999999997e-01*G0_0_0_1 + 3.749999999999994e-04*G1_;
  block[6] = -4.999999999999997e-01*G0_0_1_0 - 4.999999999999996e-01*G0_0_1_1 + 3.749999999999992e-04*G1_;
  block[7] = 4.999999999999997e-01*G0_0_1_0 + 3.749999999999993e-04*G1_;
  block[8] = 4.999999999999996e-01*G0_0_1_1 + 7.499999999999986e-04*G1_;
}
...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G1_0_3_0 = det*c2_0*c1_3*map.g01;
  const real G1_0_3_1 = det*c2_0*c1_3*map.g11;
  ...
  const real G2_0_0_0 = det*c0_0*map.g00;
  const real G2_0_1_0 = det*c0_0*map.g10;
  const real G2_1_0_0 = det*c0_1*map.g00;
  const real G2_2_1_0 = det*c0_2*map.g10;
  const real G2_3_0_1 = det*c0_3*map.g01;
  const real G2_3_1_1 = det*c0_3*map.g11;
  const real G2_4_0_1 = det*c0_4*map.g01;
  const real G2_5_1_1 = det*c0_5*map.g11;
  const real G3_0_0_0_0_0_0_0 = det*c2_0*c3_0*c0_0*map.g00*map.g00;
  const real G3_0_0_0_0_0_0_1 = det*c2_0*c3_0*c0_0*map.g00*map.g10;
  const real G3_0_0_0_0_0_1_0 = det*c2_0*c3_0*c0_1*map.g00*map.g00;
  const real G3_0_0_0_0_0_2_1 = det*c2_0*c3_0*c0_2*map.g00*map.g10;
  const real G3_0_0_0_0_1_0_0 = det*c2_0*c3_0*c0_0*map.g10*map.g00;
  const real G3_0_0_0_0_1_0_1 = det*c2_0*c3_0*c0_0*map.g10*map.g10;
  const real G3_0_0_0_0_1_1_0 = det*c2_0*c3_0*c0_1*map.g10*map.g00;
  const real G3_0_0_0_0_1_2_1 = det*c2_0*c3_0*c0_2*map.g10*map.g10;
  const real G3_0_1_0_1_0_0_0 = det*c2_0*c3_1*c0_0*map.g00*map.g01;
  const real G3_0_1_0_1_0_0_1 = det*c2_0*c3_1*c0_0*map.g00*map.g11;
  const real G3_0_1_0_1_0_1_0 = det*c2_0*c3_1*c0_1*map.g00*map.g01;
  const real G3_0_1_0_1_0_2_1 = det*c2_0*c3_1*c0_2*map.g00*map.g11;
  const real G3_0_1_0_1_1_0_0 = det*c2_0*c3_1*c0_0*map.g10*map.g01;
  const real G3_0_1_0_1_1_0_1 = det*c2_0*c3_1*c0_0*map.g10*map.g11;
  const real G3_0_1_0_1_1_1_0 = det*c2_0*c3_1*c0_1*map.g10*map.g01;
  const real G3_0_1_0_1_1_2_1 = det*c2_0*c3_1*c0_2*map.g10*map.g11;
  const real G3_1_0_0_0_0_3_0 = det*c2_0*c3_0*c0_3*map.g01*map.g00;
  const real G3_1_0_0_0_0_3_1 = det*c2_0*c3_0*c0_3*map.g01*map.g10;
  const real G3_1_0_0_0_0_4_0 = det*c2_0*c3_0*c0_4*map.g01*map.g00;
  const real G3_1_0_0_0_0_5_1 = det*c2_0*c3_0*c0_5*map.g01*map.g10;
  const real G3_1_0_0_0_1_3_0 = det*c2_0*c3_0*c0_3*map.g11*map.g00;
  const real G3_1_0_0_0_1_3_1 = det*c2_0*c3_0*c0_3*map.g11*map.g10;
  const real G3_1_0_0_0_1_4_0 = det*c2_0*c3_0*c0_4*map.g11*map.g00;
  const real G3_1_0_0_0_1_5_1 = det*c2_0*c3_0*c0_5*map.g11*map.g10;
  const real G3_1_1_0_1_0_3_0 = det*c2_0*c3_1*c0_3*map.g01*map.g01;
  const real G3_1_1_0_1_0_3_1 = det*c2_0*c3_1*c0_3*map.g01*map.g11;
  const real G3_1_1_0_1_0_4_0 = det*c2_0*c3_1*c0_4*map.g01*map.g01;
  const real G3_1_1_0_1_0_5_1 = det*c2_0*c3_1*c0_5*map.g01*map.g11;
  const real G3_1_1_0_1_1_3_0 = det*c2_0*c3_1*c0_3*map.g11*map.g01;
  const real G3_1_1_0_1_1_3_1 = det*c2_0*c3_1*c0_3*map.g11*map.g11;
  const real G3_1_1_0_1_1_4_0 = det*c2_0*c3_1*c0_4*map.g11*map.g01;
  const real G3_1_1_0_1_1_5_1 = det*c2_0*c3_1*c0_5*map.g11*map.g11;
