...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Label::fill_expressions(std::vector<repr_t> const& reprs)
  {
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Label::fill_expressions(dolfin::uint const& count)
  {
    std::vector<Expression const *> expr;
    return expr;
  }
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Variable::fill_expressions(std::vector<repr_t> const& reprs)
  {
    std::vector<Expression const *> expr;
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Variable::fill_expressions(Expression const& e, Label const& l)
  {
    std::vector<Expression const *> expr;
    expr.push_back(&e);
    expr.push_back(&l);
