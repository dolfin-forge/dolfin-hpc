...
MTL4Matrix::MTL4Matrix():
  Variable("A", "MTL4 matrix"),
  A(0), is_view(false), ins(0)
{
...
MTL4Matrix::MTL4Matrix(const MTL4Matrix& A):
  Variable("A", "MTL4 matrix"),
  A(0), is_view(true), ins(0)
{
  error("Not implemented.");
}
//-----------------------------------------------------------------------------
MTL4Matrix::MTL4Matrix(MTL4_sparse_matrix* A):
		     ...
		     uint n, const uint* cols)
{
  if(!ins)
    ins = new mtl::matrix::
      inserter<MTL4_sparse_matrix, mtl::update_plus<real> >(*A, 3);
...
//-----------------------------------------------------------------------------
MTL4_sparse_matrix& MTL4Matrix::mat() const
{
  return *A;
}
//-----------------------------------------------------------------------------
