...
#ifndef __UFL_TENSOR_ELEMENT_H_
#define __UFL_TENSOR_ELEMENT_H_
...
class UFLTensorElement : public UFLFiniteElementBase
{

public:

  ///
  UFLTensorElement(UFLElementList::FamilyType family, UFLCell const& cell,
