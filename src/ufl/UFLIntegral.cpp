...
//-----------------------------------------------------------------------------
MeasureData::MappingReprToType const MeasureData::__init_mapping_repr_to_type()
{
  MappingReprToType m;
...
//-----------------------------------------------------------------------------
MeasureData::MappingTypeToRepr const MeasureData::__init_mapping_type_to_repr()
{
  MappingTypeToRepr m;
...
//-----------------------------------------------------------------------------
std::string const MeasureData::type_repr(MeasureData::Type const& t)
{
  return MappingToRepr().find(t)->second;
}

//-----------------------------------------------------------------------------
MeasureData::Type const MeasureData::repr_type(repr_t const& repr)
{
  return MappingToType().find(repr)->second;
}

//-----------------------------------------------------------------------------
MeasureData::Type const MeasureData::type() const
{
  return type_;
}
...
MeasureDomain::MappingReprToType const MeasureDomain::__init_mapping_repr_to_type()
{
  ...
  m.insert(MappingReprToTypeItem(Object::repr_t("'ds'"), MeasureDomain::exterior_facet));
  m.insert(MappingReprToTypeItem(Object::repr_t("'dS'"), MeasureDomain::interior_facet));
  m.insert(MappingReprToTypeItem(Object::repr_t("'dE'"), MeasureDomain::macro_cell));
  m.insert(MappingReprToTypeItem(Object::repr_t("'dc'"), MeasureDomain::surface));
  return m;
}
...
//-----------------------------------------------------------------------------
  std::vector<Class const*> const Integral::operands(std::string const& name) const
  {
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Integral::fill_expressions(std::vector<repr_t> const& reprs)
  {
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const Integral::fill_expressions(Expression const& e)
  {
    std::vector<Expression const *> expr;
    expr.push_back(&e);
    return expr;
