...
void LinearForm::eval(real block[], const AffineMap& map) const
{
  ...
  const real G2_3_0 = map.det*c0*c0_3*map.g00;
  const real G2_3_1 = map.det*c0*c0_3*map.g10;
  const real G2_4_0 = map.det*c0*c0_4*map.g00;
  const real G2_5_1 = map.det*c0*c0_5*map.g10;
  const real G3_3_0 = map.det*c0*c0_3*map.g00;
  const real G3_3_1 = map.det*c0*c0_3*map.g10;
  const real G3_4_0 = map.det*c0*c0_4*map.g00;
  const real G3_5_1 = map.det*c0*c0_5*map.g10;
  const real G4_0_0 = map.det*c0*c0_0*map.g01;
  const real G4_0_1 = map.det*c0*c0_0*map.g11;
  const real G4_1_0 = map.det*c0*c0_1*map.g01;
  const real G4_2_1 = map.det*c0*c0_2*map.g11;
  const real G5_3_0 = map.det*c0*c0_3*map.g01 + map.det*c0*c0_3*map.g01;
  const real G5_3_1 = map.det*c0*c0_3*map.g11 + map.det*c0*c0_3*map.g11;
  const real G5_4_0 = map.det*c0*c0_4*map.g01 + map.det*c0*c0_4*map.g01;
  const real G5_5_1 = map.det*c0*c0_5*map.g11 + map.det*c0*c0_5*map.g11;
