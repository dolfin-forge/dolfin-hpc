...
void BilinearForm::eval(real block[], const AffineMap& map) const
{
  ...
  block[4] = 8.333333333333307e-03*G0_;
  block[5] = 1.666666666666662e-02*G0_;
  block[6] = 8.333333333333309e-03*G0_;
  block[7] = 8.333333333333312e-03*G0_;
  block[8] = 8.333333333333305e-03*G0_;
  block[9] = 8.333333333333309e-03*G0_;
  block[10] = 1.666666666666662e-02*G0_;
  block[11] = 8.333333333333309e-03*G0_;
