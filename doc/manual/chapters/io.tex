...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{|l|l|l|}
      ...
      \hline
      \texttt{.bin}  & \texttt{File::binary} & \dolfin{} Binary \\
      \hline
...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{|l||c|c|c|c|c|c|}
      \hline
      Format           & \texttt{Vector} & \texttt{Matrix} & \texttt{Mesh} & \texttt{Function} & \texttt{Sample} & \texttt{Parallel}\\
      \hline
      \hline
      \texttt{File::xml}     & in/out & in/out & in/out & --- & --- & Partial \\
      \hline
      \texttt{File::binary}     & in/out & --- & in/out & in/out & --- & Yes\\
      \hline
      \texttt{File::vtk}     & ---    & ---    & out    & out & --- & Yes \\
      \hline
      \texttt{File::octave}  & out    & out    & out    & out & out & No \\
      \hline
      \texttt{File::matlab}  & out    & out    & out    & out & out & No\\
      \hline
    \end{tabular}
...
\subsection{\dolfin{} Binary}
\index{DOLFIN Binary}

\dolfin{} Binary is the new native HPC format of \dolfin{} and the only format with support for parallel I/O. As the name says, data is stored in uncompressed binary with some additionally header information. A complete specification of the file format can be found in appendix \ref{app:dolfin_binary}


. As the name says, data is stored in uncompressed binary format.

with
support for parallel I/O in the form of MPI I/O \cite{mpi}.
