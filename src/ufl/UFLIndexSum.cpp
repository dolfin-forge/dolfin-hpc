...
//-----------------------------------------------------------------------------
  IndexSum::IndexSum(Expression const& expression, tuple<IndexBase> const& indices,
  ...
  tuple<Index> const IndexSum::free_indices() const
  {
    ...
    for(dolfin::uint i=0; i<sum_indices.size(); ++i)
      if(sum_indices[i] != f_indices[0])
        new_indices.push_back(sum_indices[i]);
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const IndexSum::fill_expressions(std::vector<repr_t> const& reprs)
  {
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const IndexSum::fill_expressions(Expression const& expression, MultiIndex const& multi_index)
  {
    std::vector<Expression const *> expr;
...
//-----------------------------------------------------------------------------
  std::vector<Expression const *> const IndexSum::fill_expressions(Expression const& expression,
