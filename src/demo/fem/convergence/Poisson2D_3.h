...
public:
  ...
  void eval(real block[], const AffineMap& map) const
  {
    ...
    block[37] = block[73];
    block[85] = -block[73] + 3.375000000000001e-01*G0_1_1;
    block[58] = block[85];
    block[90] = block[85] + 1.687499999999992e-01*G0_0_1 + 1.687499999999991e-01*G0_1_0;
    block[16] = block[90] + -3.749999999999909e-02*G0_0_0;
    block[67] = -5.000000000000023e+00*block[85];
    block[76] = block[67];
    block[11] = block[90] + 4.250000000000000e-01*G0_0_0;
    block[82] = block[90] + -3.750000000000035e-02*G0_1_1;
    block[7] = -block[82] + -6.749999999999997e-01*G0_0_0 + 3.749999999999971e-02*G0_0_1 + -6.749999999999996e-01*G0_1_0;
    block[40] = -block[7] + -7.124999999999997e-01*G0_0_0 + -7.124999999999995e-01*G0_1_0;
    block[4] = block[40];
    block[32] = -block[82] + -2.999999999999996e-01*G0_0_1;
    block[45] = -block[67] + -1.687499999999998e+00*G0_0_0;
    block[69] = 1.200000000000000e+00*block[45];
    block[55] = -block[45] + 1.687499999999999e+00*G0_1_1;
    block[93] = block[69];
    block[60] = block[7] + 7.124999999999999e-01*G0_0_0 + -7.124999999999985e-01*G0_1_1;
    block[75] = block[85];
    block[31] = -block[16] + 7.124999999999992e-01*G0_1_0;
    block[99] = 2.400000000000000e+00*block[55];
    block[78] = -block[73] + -1.350000000000000e+00*G0_0_0 + -1.012500000000001e+00*G0_1_0;
    block[21] = block[90] + 8.750000000000020e-02*G0_1_0;
    block[1] = -block[21] + -8.750000000000012e-02*G0_0_0;
    block[89] = -6.000000000000029e+00*block[85];
    block[94] = -6.000000000000004e+00*block[73];
    block[51] = block[16];
    block[72] = block[82];
    block[15] = block[16];
    block[36] = -block[85] + 3.374999999999995e-01*G0_0_0;
    block[22] = block[90] + 4.249999999999997e-01*G0_1_1;
    block[86] = block[85];
    block[41] = -block[16] + -2.999999999999993e-01*G0_1_0;
    block[97] = block[94];
    block[64] = block[36];
    block[54] = block[45];
    block[71] = -block[41] + 3.750000000000004e-01*G0_0_0;
    block[5] = -block[40] + 2.999999999999995e-01*G0_0_1 + 2.999999999999999e-01*G0_1_1;
    block[8] = block[7] + 1.012500000000000e+00*G0_0_0 + 1.012500000000000e+00*G0_1_0;
    block[35] = block[36];
    block[27] = block[82];
    block[83] = -5.000000000000006e+00*block[73];
    block[46] = block[36];
    block[92] = block[90];
    block[61] = block[16];
    block[57] = block[85];
    block[74] = block[73];
    block[13] = -block[16] + 7.124999999999998e-01*G0_0_1;
    block[48] = block[73];
    block[30] = block[40];
    block[28] = block[82];
    block[98] = block[89];
    block[80] = -block[40] + 3.000000000000000e-01*G0_0_0 + 2.999999999999999e-01*G0_0_1;
    block[62] = -block[32] + 3.750000000000003e-01*G0_1_1;
    block[50] = -block[40] + 2.999999999999997e-01*G0_1_0 + 2.999999999999998e-01*G0_1_1;
    block[14] = -block[16] + -2.999999999999989e-01*G0_0_1;
    block[39] = block[69];
    block[23] = -block[82] + -2.999999999999994e-01*G0_1_0;
    block[26] = -block[23] + 3.750000000000004e-01*G0_1_1;
    block[19] = block[90];
    block[87] = -block[73] + -1.350000000000000e+00*G0_0_0 + -1.012500000000001e+00*G0_0_1;
    block[42] = -block[82] + 7.124999999999991e-01*G0_0_1;
    block[96] = block[69];
    block[65] = -block[36] + -1.012500000000000e+00*G0_0_1 + -1.349999999999999e+00*G0_1_1;
    block[53] = block[36];
    block[70] = block[7] + -7.124999999999994e-01*G0_0_1 + 7.124999999999995e-01*G0_1_0;
    block[68] = block[85];
    block[6] = -block[40] + -7.124999999999990e-01*G0_0_1 + -7.124999999999987e-01*G0_1_1;
    block[17] = -block[14] + 3.750000000000004e-01*G0_0_0;
    block[9] = block[90];
    block[34] = -block[73] + -3.374999999999997e-01*G0_0_0 + 1.012499999999998e+00*G0_0_1;
    block[24] = -block[82] + 7.124999999999992e-01*G0_1_0;
    block[25] = -block[24] + -6.374999999999997e-01*G0_1_1;
    block[84] = block[73];
    block[59] = block[89];
    block[47] = block[73];
    block[91] = block[90];
    block[66] = block[55];
    block[56] = -block[36] + -1.012499999999999e+00*G0_1_0 + -1.349999999999998e+00*G0_1_1;
    block[77] = block[55];
    block[3] = block[40];
    block[12] = block[90] + 8.750000000000008e-02*G0_0_1;
    block[10] = -block[12] + -8.750000000000013e-02*G0_0_0;
    block[2] = -block[12] + -8.750000000000001e-02*G0_1_1;
    block[49] = block[94];
    block[33] = block[55];
    block[29] = block[90];
    block[81] = -block[31] + -6.374999999999994e-01*G0_0_0;
    block[44] = block[55];
    block[63] = block[36];
    block[0] = -1.133333333333332e+01*block[40];
    block[79] = block[94];
    block[38] = block[83];
    block[20] = -block[21] + -8.750000000000001e-02*G0_1_1;
    block[18] = -block[13] + -6.374999999999993e-01*G0_0_0;
    block[88] = block[55];
    block[43] = -block[73] + -3.374999999999996e-01*G0_0_0 + 1.012499999999998e+00*G0_1_0;
    block[95] = block[89];
    block[52] = -block[42] + -6.374999999999996e-01*G0_1_1;
  }
