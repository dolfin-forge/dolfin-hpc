...
void BilinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G6_0_0_0_0 = det*c0_0*c0_0*map.g00*map.g00 + det*c0_0*c0_0*map.g01*map.g01;
  const real G6_0_0_0_1 = det*c0_0*c0_0*map.g00*map.g10 + det*c0_0*c0_0*map.g01*map.g11;
  const real G6_0_0_1_0 = det*c0_0*c0_0*map.g10*map.g00 + det*c0_0*c0_0*map.g11*map.g01;
  const real G6_0_0_1_1 = det*c0_0*c0_0*map.g10*map.g10 + det*c0_0*c0_0*map.g11*map.g11;
  const real G6_0_1_0_0 = det*c0_0*c0_1*map.g00*map.g00 + det*c0_0*c0_1*map.g01*map.g01;
  const real G6_0_1_0_1 = det*c0_0*c0_1*map.g00*map.g10 + det*c0_0*c0_1*map.g01*map.g11;
  const real G6_0_1_1_0 = det*c0_0*c0_1*map.g10*map.g00 + det*c0_0*c0_1*map.g11*map.g01;
  const real G6_0_1_1_1 = det*c0_0*c0_1*map.g10*map.g10 + det*c0_0*c0_1*map.g11*map.g11;
  const real G6_0_2_0_0 = det*c0_0*c0_2*map.g00*map.g00 + det*c0_0*c0_2*map.g01*map.g01;
  const real G6_0_2_0_1 = det*c0_0*c0_2*map.g00*map.g10 + det*c0_0*c0_2*map.g01*map.g11;
  const real G6_0_2_1_0 = det*c0_0*c0_2*map.g10*map.g00 + det*c0_0*c0_2*map.g11*map.g01;
  const real G6_0_2_1_1 = det*c0_0*c0_2*map.g10*map.g10 + det*c0_0*c0_2*map.g11*map.g11;
  const real G6_1_0_0_0 = det*c0_1*c0_0*map.g00*map.g00 + det*c0_1*c0_0*map.g01*map.g01;
  const real G6_1_0_0_1 = det*c0_1*c0_0*map.g00*map.g10 + det*c0_1*c0_0*map.g01*map.g11;
  const real G6_1_0_1_0 = det*c0_1*c0_0*map.g10*map.g00 + det*c0_1*c0_0*map.g11*map.g01;
  const real G6_1_0_1_1 = det*c0_1*c0_0*map.g10*map.g10 + det*c0_1*c0_0*map.g11*map.g11;
  const real G6_1_1_0_0 = det*c0_1*c0_1*map.g00*map.g00 + det*c0_1*c0_1*map.g01*map.g01;
  const real G6_1_1_0_1 = det*c0_1*c0_1*map.g00*map.g10 + det*c0_1*c0_1*map.g01*map.g11;
  const real G6_1_1_1_0 = det*c0_1*c0_1*map.g10*map.g00 + det*c0_1*c0_1*map.g11*map.g01;
  const real G6_1_1_1_1 = det*c0_1*c0_1*map.g10*map.g10 + det*c0_1*c0_1*map.g11*map.g11;
  const real G6_1_2_0_0 = det*c0_1*c0_2*map.g00*map.g00 + det*c0_1*c0_2*map.g01*map.g01;
  const real G6_1_2_0_1 = det*c0_1*c0_2*map.g00*map.g10 + det*c0_1*c0_2*map.g01*map.g11;
  const real G6_1_2_1_0 = det*c0_1*c0_2*map.g10*map.g00 + det*c0_1*c0_2*map.g11*map.g01;
  const real G6_1_2_1_1 = det*c0_1*c0_2*map.g10*map.g10 + det*c0_1*c0_2*map.g11*map.g11;
  const real G6_2_0_0_0 = det*c0_2*c0_0*map.g00*map.g00 + det*c0_2*c0_0*map.g01*map.g01;
  const real G6_2_0_0_1 = det*c0_2*c0_0*map.g00*map.g10 + det*c0_2*c0_0*map.g01*map.g11;
  const real G6_2_0_1_0 = det*c0_2*c0_0*map.g10*map.g00 + det*c0_2*c0_0*map.g11*map.g01;
  const real G6_2_0_1_1 = det*c0_2*c0_0*map.g10*map.g10 + det*c0_2*c0_0*map.g11*map.g11;
  const real G6_2_1_0_0 = det*c0_2*c0_1*map.g00*map.g00 + det*c0_2*c0_1*map.g01*map.g01;
  const real G6_2_1_0_1 = det*c0_2*c0_1*map.g00*map.g10 + det*c0_2*c0_1*map.g01*map.g11;
  const real G6_2_1_1_0 = det*c0_2*c0_1*map.g10*map.g00 + det*c0_2*c0_1*map.g11*map.g01;
  const real G6_2_1_1_1 = det*c0_2*c0_1*map.g10*map.g10 + det*c0_2*c0_1*map.g11*map.g11;
  const real G6_2_2_0_0 = det*c0_2*c0_2*map.g00*map.g00 + det*c0_2*c0_2*map.g01*map.g01;
  const real G6_2_2_0_1 = det*c0_2*c0_2*map.g00*map.g10 + det*c0_2*c0_2*map.g01*map.g11;
  const real G6_2_2_1_0 = det*c0_2*c0_2*map.g10*map.g00 + det*c0_2*c0_2*map.g11*map.g01;
  const real G6_2_2_1_1 = det*c0_2*c0_2*map.g10*map.g10 + det*c0_2*c0_2*map.g11*map.g11;
...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G1_0_0_0_0 = det*c1_0*c1_0*c0_0*map.g00;
  const real G1_0_0_0_1 = det*c1_0*c1_0*c0_1*map.g00;
  const real G1_0_0_0_2 = det*c1_0*c1_0*c0_2*map.g00;
  const real G1_0_0_1_0 = det*c1_0*c1_0*c0_0*map.g10;
  const real G1_0_0_1_1 = det*c1_0*c1_0*c0_1*map.g10;
  const real G1_0_0_1_2 = det*c1_0*c1_0*c0_2*map.g10;
  const real G1_0_1_0_0 = det*c1_0*c1_1*c0_0*map.g00;
  const real G1_0_1_0_1 = det*c1_0*c1_1*c0_1*map.g00;
  const real G1_0_1_0_2 = det*c1_0*c1_1*c0_2*map.g00;
  const real G1_0_1_1_0 = det*c1_0*c1_1*c0_0*map.g10;
  const real G1_0_1_1_1 = det*c1_0*c1_1*c0_1*map.g10;
  const real G1_0_1_1_2 = det*c1_0*c1_1*c0_2*map.g10;
  const real G1_0_2_0_0 = det*c1_0*c1_2*c0_0*map.g00;
  const real G1_0_2_0_1 = det*c1_0*c1_2*c0_1*map.g00;
  const real G1_0_2_0_2 = det*c1_0*c1_2*c0_2*map.g00;
  const real G1_0_2_1_0 = det*c1_0*c1_2*c0_0*map.g10;
  const real G1_0_2_1_1 = det*c1_0*c1_2*c0_1*map.g10;
  const real G1_0_2_1_2 = det*c1_0*c1_2*c0_2*map.g10;
  const real G1_1_0_0_0 = det*c1_1*c1_0*c0_0*map.g00;
  const real G1_1_0_0_1 = det*c1_1*c1_0*c0_1*map.g00;
  const real G1_1_0_0_2 = det*c1_1*c1_0*c0_2*map.g00;
  const real G1_1_0_1_0 = det*c1_1*c1_0*c0_0*map.g10;
  const real G1_1_0_1_1 = det*c1_1*c1_0*c0_1*map.g10;
  const real G1_1_0_1_2 = det*c1_1*c1_0*c0_2*map.g10;
  const real G1_1_1_0_0 = det*c1_1*c1_1*c0_0*map.g00;
  const real G1_1_1_0_1 = det*c1_1*c1_1*c0_1*map.g00;
  const real G1_1_1_0_2 = det*c1_1*c1_1*c0_2*map.g00;
  const real G1_1_1_1_0 = det*c1_1*c1_1*c0_0*map.g10;
  const real G1_1_1_1_1 = det*c1_1*c1_1*c0_1*map.g10;
  const real G1_1_1_1_2 = det*c1_1*c1_1*c0_2*map.g10;
  const real G1_1_2_0_0 = det*c1_1*c1_2*c0_0*map.g00;
  const real G1_1_2_0_1 = det*c1_1*c1_2*c0_1*map.g00;
  const real G1_1_2_0_2 = det*c1_1*c1_2*c0_2*map.g00;
  const real G1_1_2_1_0 = det*c1_1*c1_2*c0_0*map.g10;
  const real G1_1_2_1_1 = det*c1_1*c1_2*c0_1*map.g10;
  const real G1_1_2_1_2 = det*c1_1*c1_2*c0_2*map.g10;
  const real G1_2_0_0_0 = det*c1_2*c1_0*c0_0*map.g00;
  const real G1_2_0_0_1 = det*c1_2*c1_0*c0_1*map.g00;
  const real G1_2_0_0_2 = det*c1_2*c1_0*c0_2*map.g00;
  const real G1_2_0_1_0 = det*c1_2*c1_0*c0_0*map.g10;
  const real G1_2_0_1_1 = det*c1_2*c1_0*c0_1*map.g10;
  const real G1_2_0_1_2 = det*c1_2*c1_0*c0_2*map.g10;
  const real G1_2_1_0_0 = det*c1_2*c1_1*c0_0*map.g00;
  const real G1_2_1_0_1 = det*c1_2*c1_1*c0_1*map.g00;
  const real G1_2_1_0_2 = det*c1_2*c1_1*c0_2*map.g00;
  const real G1_2_1_1_0 = det*c1_2*c1_1*c0_0*map.g10;
  const real G1_2_1_1_1 = det*c1_2*c1_1*c0_1*map.g10;
  const real G1_2_1_1_2 = det*c1_2*c1_1*c0_2*map.g10;
  const real G1_2_2_0_0 = det*c1_2*c1_2*c0_0*map.g00;
  const real G1_2_2_0_1 = det*c1_2*c1_2*c0_1*map.g00;
  const real G1_2_2_0_2 = det*c1_2*c1_2*c0_2*map.g00;
  const real G1_2_2_1_0 = det*c1_2*c1_2*c0_0*map.g10;
  const real G1_2_2_1_1 = det*c1_2*c1_2*c0_1*map.g10;
  const real G1_2_2_1_2 = det*c1_2*c1_2*c0_2*map.g10;
  const real G2_3 = det*c0_3;
  const real G2_4 = det*c0_4;
  const real G2_5 = det*c0_5;
  const real G3_0_0_0_3 = det*c1_0*c1_0*c0_3*map.g01;
  const real G3_0_0_0_4 = det*c1_0*c1_0*c0_4*map.g01;
  const real G3_0_0_0_5 = det*c1_0*c1_0*c0_5*map.g01;
  const real G3_0_0_1_3 = det*c1_0*c1_0*c0_3*map.g11;
  const real G3_0_0_1_4 = det*c1_0*c1_0*c0_4*map.g11;
  const real G3_0_0_1_5 = det*c1_0*c1_0*c0_5*map.g11;
  const real G3_0_1_0_3 = det*c1_0*c1_1*c0_3*map.g01;
  const real G3_0_1_0_4 = det*c1_0*c1_1*c0_4*map.g01;
  const real G3_0_1_0_5 = det*c1_0*c1_1*c0_5*map.g01;
  const real G3_0_1_1_3 = det*c1_0*c1_1*c0_3*map.g11;
  const real G3_0_1_1_4 = det*c1_0*c1_1*c0_4*map.g11;
  const real G3_0_1_1_5 = det*c1_0*c1_1*c0_5*map.g11;
  const real G3_0_2_0_3 = det*c1_0*c1_2*c0_3*map.g01;
  const real G3_0_2_0_4 = det*c1_0*c1_2*c0_4*map.g01;
  const real G3_0_2_0_5 = det*c1_0*c1_2*c0_5*map.g01;
  const real G3_0_2_1_3 = det*c1_0*c1_2*c0_3*map.g11;
  const real G3_0_2_1_4 = det*c1_0*c1_2*c0_4*map.g11;
  const real G3_0_2_1_5 = det*c1_0*c1_2*c0_5*map.g11;
  const real G3_1_0_0_3 = det*c1_1*c1_0*c0_3*map.g01;
  const real G3_1_0_0_4 = det*c1_1*c1_0*c0_4*map.g01;
  const real G3_1_0_0_5 = det*c1_1*c1_0*c0_5*map.g01;
  const real G3_1_0_1_3 = det*c1_1*c1_0*c0_3*map.g11;
  const real G3_1_0_1_4 = det*c1_1*c1_0*c0_4*map.g11;
  const real G3_1_0_1_5 = det*c1_1*c1_0*c0_5*map.g11;
  const real G3_1_1_0_3 = det*c1_1*c1_1*c0_3*map.g01;
  const real G3_1_1_0_4 = det*c1_1*c1_1*c0_4*map.g01;
  const real G3_1_1_0_5 = det*c1_1*c1_1*c0_5*map.g01;
  const real G3_1_1_1_3 = det*c1_1*c1_1*c0_3*map.g11;
  const real G3_1_1_1_4 = det*c1_1*c1_1*c0_4*map.g11;
  const real G3_1_1_1_5 = det*c1_1*c1_1*c0_5*map.g11;
  const real G3_1_2_0_3 = det*c1_1*c1_2*c0_3*map.g01;
  const real G3_1_2_0_4 = det*c1_1*c1_2*c0_4*map.g01;
  const real G3_1_2_0_5 = det*c1_1*c1_2*c0_5*map.g01;
  const real G3_1_2_1_3 = det*c1_1*c1_2*c0_3*map.g11;
  const real G3_1_2_1_4 = det*c1_1*c1_2*c0_4*map.g11;
  const real G3_1_2_1_5 = det*c1_1*c1_2*c0_5*map.g11;
  const real G3_2_0_0_3 = det*c1_2*c1_0*c0_3*map.g01;
  const real G3_2_0_0_4 = det*c1_2*c1_0*c0_4*map.g01;
  const real G3_2_0_0_5 = det*c1_2*c1_0*c0_5*map.g01;
  const real G3_2_0_1_3 = det*c1_2*c1_0*c0_3*map.g11;
  const real G3_2_0_1_4 = det*c1_2*c1_0*c0_4*map.g11;
  const real G3_2_0_1_5 = det*c1_2*c1_0*c0_5*map.g11;
  const real G3_2_1_0_3 = det*c1_2*c1_1*c0_3*map.g01;
  const real G3_2_1_0_4 = det*c1_2*c1_1*c0_4*map.g01;
  const real G3_2_1_0_5 = det*c1_2*c1_1*c0_5*map.g01;
  const real G3_2_1_1_3 = det*c1_2*c1_1*c0_3*map.g11;
  const real G3_2_1_1_4 = det*c1_2*c1_1*c0_4*map.g11;
  const real G3_2_1_1_5 = det*c1_2*c1_1*c0_5*map.g11;
  const real G3_2_2_0_3 = det*c1_2*c1_2*c0_3*map.g01;
  const real G3_2_2_0_4 = det*c1_2*c1_2*c0_4*map.g01;
  const real G3_2_2_0_5 = det*c1_2*c1_2*c0_5*map.g01;
  const real G3_2_2_1_3 = det*c1_2*c1_2*c0_3*map.g11;
  const real G3_2_2_1_4 = det*c1_2*c1_2*c0_4*map.g11;
  const real G3_2_2_1_5 = det*c1_2*c1_2*c0_5*map.g11;
