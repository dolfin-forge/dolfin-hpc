...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  const real G0_0_1_0 = det*c0_1*map.g00*map.g00 + det*c0_1*map.g01*map.g01;
  const real G0_0_2_1 = det*c0_2*map.g00*map.g10 + det*c0_2*map.g01*map.g11;
  const real G0_1_0_0 = det*c0_0*map.g10*map.g00 + det*c0_0*map.g11*map.g01;
  const real G0_1_0_1 = det*c0_0*map.g10*map.g10 + det*c0_0*map.g11*map.g11;
  const real G0_1_1_0 = det*c0_1*map.g10*map.g00 + det*c0_1*map.g11*map.g01;
  const real G0_1_2_1 = det*c0_2*map.g10*map.g10 + det*c0_2*map.g11*map.g11;
