...
public:
  ...
  virtual const char* signature() const
  {
    return "(dXa0/dx0)(dXa1/dx0) | ((d/dXa0)vi0)*((d/dXa1)vi1)*dX(0) + (dXa0/dx1)(dXa1/dx1) | ((d/dXa0)vi0)*((d/dXa1)vi1)*dX(0) + (dXa0/dx2)(dXa1/dx2) | ((d/dXa0)vi0)*((d/dXa1)vi1)*dX(0) + 2.0 | vi0*vi1*ds(0)";
  }
