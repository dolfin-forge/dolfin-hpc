...
namespace dolfin { namespace ElasticityUpdatedSigma2 {
...
public:
  ...
  void eval(real block[], const AffineMap& map) const
  {
    ...
    real G1_0_0 = map.det*c1*c[0][0]*map.g02;
    real G1_0_1 = map.det*c1*c[0][0]*map.g12;
    real G1_0_2 = map.det*c1*c[0][0]*map.g22;
    real G1_1_0 = map.det*c1*c[0][1]*map.g02;
    real G1_2_1 = map.det*c1*c[0][2]*map.g12;
    real G1_3_2 = map.det*c1*c[0][3]*map.g22;
    real G1_4_0 = map.det*c1*c[0][4]*map.g02;
    real G1_4_1 = map.det*c1*c[0][4]*map.g12;
    real G1_4_2 = map.det*c1*c[0][4]*map.g22;
    real G1_5_0 = map.det*c1*c[0][5]*map.g02;
    real G1_6_1 = map.det*c1*c[0][6]*map.g12;
    real G1_7_2 = map.det*c1*c[0][7]*map.g22;
    real G1_8_0 = map.det*c1*c[0][8]*map.g02;
    real G1_8_1 = map.det*c1*c[0][8]*map.g12;
    real G1_8_2 = map.det*c1*c[0][8]*map.g22;
    real G1_9_0 = map.det*c1*c[0][9]*map.g02;
    real G1_10_1 = map.det*c1*c[0][10]*map.g12;
    real G1_11_2 = map.det*c1*c[0][11]*map.g22;
    real G2_0_8_0 = map.det*c1*c[0][8]*map.g00;
    real G2_0_8_1 = map.det*c1*c[0][8]*map.g10;
    real G2_0_8_2 = map.det*c1*c[0][8]*map.g20;
    real G2_0_9_0 = map.det*c1*c[0][9]*map.g00;
    real G2_0_10_1 = map.det*c1*c[0][10]*map.g10;
    real G2_0_11_2 = map.det*c1*c[0][11]*map.g20;
    real G2_1_8_0 = map.det*c1*c[0][8]*map.g01;
    real G2_1_8_1 = map.det*c1*c[0][8]*map.g11;
    real G2_1_8_2 = map.det*c1*c[0][8]*map.g21;
    real G2_1_9_0 = map.det*c1*c[0][9]*map.g01;
    real G2_1_10_1 = map.det*c1*c[0][10]*map.g11;
    real G2_1_11_2 = map.det*c1*c[0][11]*map.g21;
    real G2_2_8_0 = map.det*c1*c[0][8]*map.g02;
    real G2_2_8_1 = map.det*c1*c[0][8]*map.g12;
    real G2_2_8_2 = map.det*c1*c[0][8]*map.g22;
    ...
    block[0] = -3.333333333333329e-01*G1_0_0 - 3.333333333333329e-01*G1_0_1 - 3.333333333333329e-01*G1_0_2 + 3.333333333333329e-01*G1_1_0 + 3.333333333333329e-01*G1_2_1 + 3.333333333333329e-01*G1_3_2 - 3.333333333333329e-01*G2_0_8_0 - 3.333333333333329e-01*G2_0_8_1 - 3.333333333333329e-01*G2_0_8_2 + 3.333333333333329e-01*G2_0_9_0 + 3.333333333333329e-01*G2_0_10_1 + 3.333333333333329e-01*G2_0_11_2 + 3.333333333333329e-01*G6_0_0 - 3.333333333333329e-01*G10_0;
