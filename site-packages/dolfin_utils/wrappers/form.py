...
dolfin::dolfin_error("generated code for class %s",
                         "access coeficient data",
                         "Invalid coeficient");''' % form.superclassname
    num +=  "\n    %s\n    return 0;" % message
    name += '    }\n\n    %s\n    return "unnamed";' % message

    return (num, name)
#-------------------------------------------------------------------------------
def generate_coefficient_map_data_hpc(form):
    """Generate data for code for the functions
    Form::coefficient_number and Form::coefficient_name."""
    ...
    if form.num_coefficients == 0:
        message = '''\
dolfin::error("Generated code for class %s: accessing coefficient data."
	      "There are no coefficients");''' % form.superclassname
        num  = "\n    %s\n    return 0;" % message
        name = '\n    %s\n    return "unnamed";' % message
        return (num, name)
    ...
    num_message = '''\
dolfin::error("Generated code for class %s: accessing coefficient data."
	      "Invalid coefficient name %%s", name.c_str());''' % form.superclassname
    name_message = '''\
dolfin::error("Generated code for class %s: accessing coefficient data."
	      "Invalid coefficient number %%d", i);''' % form.superclassname
    num +=  "\n    %s\n    return 0;" % num_message
    name += '    }\n\n    %s\n    return "unnamed";' % name_message
