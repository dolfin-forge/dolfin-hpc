...
public:
  ...
  virtual const char* signature() const
  {
    return "w0_a0 | vi0*va0*dX(0) + -0.025w1_a0w0_a1(dXa2/dxa3) | vi0*va0[a3]*((d/dXa2)va1)*dX(0) + -0.000125w0_a1(dXa0/dxb0)(dXa2/dxb0) | ((d/dXa0)vi0)*((d/dXa2)va1)*dX(0) + 0.05w2_a0 | vi0*va0*dX(0)";
  }
