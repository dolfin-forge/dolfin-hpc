...
//-----------------------------------------------------------------------------
  Indexed::Indexed(Expression const& expression, IndexBase const& index) :
    Class("Indexed"),
...
//-----------------------------------------------------------------------------
  std::pair<Expression const, IndexBase const> const& Indexed::operands() const
  {
...
//-----------------------------------------------------------------------------
  Indexed const* Indexed::create(repr_t const & repr) const
  {
    if(repr.length() == 0)
