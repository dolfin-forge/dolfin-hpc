...
public:
  ...
  virtual const char* signature() const
  {
    return "w0_a0(dXa1/dx0) | vi0*va0*((d/dXa1)vi1)*dX(0) + w1_a0(dXa1/dx1) | vi0*va0*((d/dXa1)vi1)*dX(0) + w2_a0(dXa1/dx2) | vi0*va0*((d/dXa1)vi1)*dX(0)";
  }
...
public:
  ...
  ConvectionMatrix3DBilinearForm(dolfin::Function& w0, dolfin::Function& w1, dolfin::Function& w2) : dolfin::Form()
  {
...
private:
  ...
  // UFC form
  UFC_ConvectionMatrix3DBilinearForm __form;
