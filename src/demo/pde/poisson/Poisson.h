...
void LinearForm::eval(real block[], const AffineMap& map, real det) const
{
  ...
  // Compute element tensor
  block[0] = 8.333333333333318e-02*G0_0 + 4.166666666666658e-02*G0_1 + 4.166666666666658e-02*G0_2;
  block[1] = 4.166666666666658e-02*G0_0 + 8.333333333333318e-02*G0_1 + 4.166666666666659e-02*G0_2;
