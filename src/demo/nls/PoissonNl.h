...
public:
  ...
  void eval(real block[], const AffineMap& map) const
  {
    ...
    real G0_0_1_0 = map.det*c[0][1]*(map.g00*map.g00 + map.g01*map.g01);
    real G0_0_2_1 = map.det*c[0][2]*(map.g00*map.g10 + map.g01*map.g11);
    real G0_1_0_0 = map.det*c[0][0]*(map.g10*map.g00 + map.g11*map.g01);
    real G0_1_0_1 = map.det*c[0][0]*(map.g10*map.g10 + map.g11*map.g11);
    real G0_1_1_0 = map.det*c[0][1]*(map.g10*map.g00 + map.g11*map.g01);
    real G0_1_2_1 = map.det*c[0][2]*(map.g10*map.g10 + map.g11*map.g11);
